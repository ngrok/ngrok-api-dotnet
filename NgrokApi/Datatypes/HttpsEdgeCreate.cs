...
namespace NgrokApi
{
    public class HttpsEdgeCreate
    {
        ...
        {
            return $"HttpsEdgeCreate Description={ Description }  Metadata={ Metadata }  Hostports={ Hostports }  MutualTls={ MutualTls }  TlsTermination={ TlsTermination } ";
        }
