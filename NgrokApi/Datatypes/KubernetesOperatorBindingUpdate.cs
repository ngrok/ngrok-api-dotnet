...
namespace NgrokApi
{
    public class KubernetesOperatorBindingUpdate
    {
        ...
        {
            return $"KubernetesOperatorBindingUpdate EndpointSelectors={ EndpointSelectors }  Csr={ Csr }  IngressEndpoint={ IngressEndpoint } ";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (KubernetesOperatorBindingUpdate)obj;
            return (
