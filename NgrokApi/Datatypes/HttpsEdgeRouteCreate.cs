...
namespace NgrokApi
{
    public class HttpsEdgeRouteCreate
    {
        // <summary>
        ...
        {
            var other = (HttpsEdgeRouteCreate)obj;
            return (
