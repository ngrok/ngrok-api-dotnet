...
namespace NgrokApi
{
    public class TcpEdgeCreate
    {
        ...
        {
            return $"TcpEdgeCreate Description={ Description }  Metadata={ Metadata }  Hostports={ Hostports }  Backend={ Backend }  IpRestriction={ IpRestriction }  TrafficPolicy={ TrafficPolicy } ";
        }
