...
namespace NgrokApi
{
    public class EndpointOAuthTwitch
    {
        ...
        {
            return $"EndpointOAuthTwitch ClientId={ ClientId }  ClientSecret={ ClientSecret }  Scopes={ Scopes }  EmailAddresses={ EmailAddresses }  EmailDomains={ EmailDomains } ";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (EndpointOAuthTwitch)obj;
            return (
