...
namespace NgrokApi
{
    public class EndpointConfigurationCreate
    {
        // <summary>
        ...
        {
            var other = (EndpointConfigurationCreate)obj;
            return (
