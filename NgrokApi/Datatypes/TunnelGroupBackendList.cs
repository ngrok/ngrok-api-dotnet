...
namespace NgrokApi
{
    public class TunnelGroupBackendList
    {
        ...
        public List<TunnelGroupBackend> Backends { get; set; }
        // <summary>
        ...
        {
            return $"TunnelGroupBackendList Backends={ Backends }  Uri={ Uri }  NextPageUri={ NextPageUri } ";
        }
        ...
        {
            var other = (TunnelGroupBackendList)obj;
            return (
