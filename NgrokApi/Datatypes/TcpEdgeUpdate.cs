...
namespace NgrokApi
{
    public class TcpEdgeUpdate : HasId
    {
        ...
        {
            return $"TcpEdgeUpdate Id={ Id }  Description={ Description }  Metadata={ Metadata }  Hostports={ Hostports }  Backend={ Backend }  IpRestriction={ IpRestriction }  TrafficPolicy={ TrafficPolicy } ";
        }
