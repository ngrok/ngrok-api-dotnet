...
namespace NgrokApi
{
    public class EventDestinationUpdate : HasId
    {
        // <summary>
        ...
        {
            return $"EventDestinationUpdate Id={ Id }  Metadata={ Metadata }  Description={ Description }  Format={ Format }  Target={ Target } ";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (EventDestinationUpdate)obj;
            return (
                 this.Id == other.Id
