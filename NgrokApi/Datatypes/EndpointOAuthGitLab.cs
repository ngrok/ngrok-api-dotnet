...
namespace NgrokApi
{
    public class EndpointOAuthGitLab
    {
        ...
        {
            return $"EndpointOAuthGitLab ClientId={ ClientId }  ClientSecret={ ClientSecret }  Scopes={ Scopes }  EmailAddresses={ EmailAddresses }  EmailDomains={ EmailDomains } ";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (EndpointOAuthGitLab)obj;
            return (
