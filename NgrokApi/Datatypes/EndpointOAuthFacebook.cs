...
namespace NgrokApi
{
    public class EndpointOAuthFacebook
    {
        ...
        {
            return $"EndpointOAuthFacebook ClientId={ ClientId }  ClientSecret={ ClientSecret }  Scopes={ Scopes }  EmailAddresses={ EmailAddresses }  EmailDomains={ EmailDomains } ";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (EndpointOAuthFacebook)obj;
            return (
