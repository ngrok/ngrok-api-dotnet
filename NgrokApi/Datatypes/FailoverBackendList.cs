...
namespace NgrokApi
{
    public class FailoverBackendList
    {
        // <summary>
        // the list of all Failover backends on this account
        // </summary>
        [JsonProperty("backends")]
        public List<FailoverBackend> Backends { get; set; }
        // <summary>
        ...
        {
            return $"FailoverBackendList Backends={ Backends }  Uri={ Uri }  NextPageUri={ NextPageUri } ";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (FailoverBackendList)obj;
            return (
