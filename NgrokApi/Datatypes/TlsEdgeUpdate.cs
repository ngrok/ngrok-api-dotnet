...
namespace NgrokApi
{
    public class TlsEdgeUpdate : HasId
    {
        // <summary>
        ...
        {
            return $"TlsEdgeUpdate Id={ Id }  Description={ Description }  Metadata={ Metadata }  Hostports={ Hostports }  Backend={ Backend }  IpRestriction={ IpRestriction }  MutualTls={ MutualTls }  TlsTermination={ TlsTermination } ";
        }
