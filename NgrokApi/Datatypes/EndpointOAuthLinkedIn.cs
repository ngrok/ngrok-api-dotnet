...
namespace NgrokApi
{
    public class EndpointOAuthLinkedIn
    {
        ...
        {
            return $"EndpointOAuthLinkedIn ClientId={ ClientId }  ClientSecret={ ClientSecret }  Scopes={ Scopes }  EmailAddresses={ EmailAddresses }  EmailDomains={ EmailDomains } ";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (EndpointOAuthLinkedIn)obj;
            return (
