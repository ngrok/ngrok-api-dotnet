...
namespace NgrokApi
{
    public class EndpointOAuthGoogle
    {
        ...
        {
            return $"EndpointOAuthGoogle ClientId={ ClientId }  ClientSecret={ ClientSecret }  Scopes={ Scopes }  EmailAddresses={ EmailAddresses }  EmailDomains={ EmailDomains } ";
        }
        ...
        {
            var other = (EndpointOAuthGoogle)obj;
            return (
