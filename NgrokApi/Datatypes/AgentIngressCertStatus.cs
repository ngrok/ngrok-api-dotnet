...
namespace NgrokApi
{
    public class AgentIngressCertStatus
    {
        ...
        public AgentIngressCertJob ProvisioningJob { get; set; }

        public override string ToString()
        {
            return $"AgentIngressCertStatus RenewsAt={ RenewsAt }  ProvisioningJob={ ProvisioningJob } ";
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            var other = (AgentIngressCertStatus)obj;
            return (
